-- Update create_order function to include signature_purchased parameter
CREATE OR REPLACE FUNCTION public.create_order(
  ...
  p_contact_firstname text DEFAULT NULL::text, 
  p_contact_lastname text DEFAULT NULL::text, 
  p_contact_email text DEFAULT NULL::text, 
  p_contact_phone text DEFAULT NULL::text, 
  p_billing_address text DEFAULT NULL::text, 
  p_return_address_name text DEFAULT NULL::text, 
  p_return_address_line1 text DEFAULT NULL::text, 
  p_return_address_line2 text DEFAULT NULL::text, 
  p_return_address_city text DEFAULT NULL::text, 
  p_return_address_state text DEFAULT NULL::text, 
  p_return_address_zip text DEFAULT NULL::text,
  p_signature_purchased boolean DEFAULT false
)
RETURNS uuid
LANGUAGE plpgsql
SECURITY DEFINER
