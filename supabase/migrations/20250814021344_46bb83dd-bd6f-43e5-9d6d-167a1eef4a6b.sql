-- Fix ambiguous column reference in create_order function
-- First drop the existing function
DROP FUNCTION IF EXISTS public.create_order(text,text,integer,numeric,numeric,text,text,numeric,text,text,text,text,text);

-- Recreate with properly prefixed parameter names
