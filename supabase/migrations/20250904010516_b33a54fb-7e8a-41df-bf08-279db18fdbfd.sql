-- Fix variable naming collision in reset_order_completely function
...
BEGIN
  ...
  CASE order_tier_name
    WHEN 'standard' THEN
      calculated_base_price := 0 * 2.50;
    WHEN 'premium' THEN  
      calculated_base_price := 0 * 3.50;
    WHEN 'luxury' THEN
      calculated_base_price := 0 * 4.50;
    ELSE
      calculated_base_price := 0 * 2.50; -- Default to standard pricing
  END CASE;
