  ...
  if (layout.isSpread) {
    ...
    <head>
      ...
      <style>
        ...
        .branding-fallback { font-size: 12px; color: #999; margin: 4px 0; }
      </style>
    </head>
    <body>
      <div class="production-layout">
        ...
        <div class="blank-half">
          <div class="branding">
            ...
            ${content.brandingLogoDataUrl ? `<img class="branding-logo" src="${content.brandingLogoDataUrl}" alt="Powered by SendYourCards.io Logo" />` : '<div class="branding-fallback">SendYourCards.io</div>'}
          </div>
        </div>
      </div>
    </body>
        ...
        <div class="inside-half">
          <div class="inside-content">
            ...
            ${content.brandingLogoDataUrl ? `<div class="branding">
              <div class="branding-text">Powered by</div>
              <img class="branding-logo" src="${content.brandingLogoDataUrl}" alt="Powered by SendYourCards.io Logo" />
            </div>` : ''}
          </div>
        </div>
      </div>
