  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Upload Your Client List</h2>
        <p className="text-gray-600">Upload a CSV file with your client information</p>
      </div>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-lg">
              File: {state.csvFile.name} ({state.clientList.length} records)
            </CardTitle>
          </CardHeader>
          <CardContent>
            {preview.length > 0 && (
      ...
      <div className="flex justify-between pt-6">
        ...
        <Button 
          onClick={nextStep}
          disabled={!state.csvFile || state.clientList.length === 0}
...
export default Step2UploadClients;
